...
function fixed_from_gregorian(g_date) {
  ...
  return ((GREGORIAN_EPOCH - 1) + (365 * (year - 1)) + quotient(year - 1, 4) - quotient(year - 1, 100) + quotient(year - 1, 400) + quotient((367 * month) - 362, 12) + (month <= 2 ? 0 : (is_gregorian_leap_year(year) ? -1 : -2)) + day);
}
